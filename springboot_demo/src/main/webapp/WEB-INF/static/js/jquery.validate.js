...
$.extend($.validator, {
	...
	classRuleSettings: {
        ...
        mobile:{mobile:true},
        simpleMobile:{simpleMobile:true}
	},
	...
	methods: {
        ...
        simpleMobile:function(value,element){
            return this.optional(element) || /^1\d{10}$/.test(value);
        },
		...
		minAmount: function(value,element,param){
			if(this.optional(element) || /^\d+(|\.\d{1,2})$/.test(value)){
				try{
		...
		maxAmount: function(value,element,param){
			if(this.optional(element) || /^\d+(|\.\d{1,2})$/.test(value)){
				try{
					return parseFloat(value) <= param;
				}catch(e){
		...
		idcard: function(value,element,param){
			return this.optional(element) || IDCard.checkCard(value);
		},
